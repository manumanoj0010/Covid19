...
navbar = html.Nav(className="navbar navbar-expand-lg navbar-light bg-light justify-content-between", children=[
    html.A(className="navbar-brand",children=['Covid-19 Tracker'], href='#', style={'font-size':'200%','text-align':'center'}),
    ...
    html.Div(className='row',children=[
        ...
        html.Div(className='col-lg-6 col-md-3 col-sm-12',children=[html.Div(className='table-responsive-sm',children=[
            ...
            html.Div(className="row alert",children=[
                ...
                html.P(children=[
                    html.P(children=[
                        html.Div(children=["Made with ",html.Span("\u2665",style={"color":"red"})," by ",html.A("TEAM TARP",href="https://www.linkedin.com/in/anthonynikhilreddy/",style={'color':'black',"font-weight":"bold"})]),
                        html.Br(),
